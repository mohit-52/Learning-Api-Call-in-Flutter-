...
ProductsModel complexJsonFromJson(String str) => ProductsModel.fromJson(json.decode(str));
String complexJsonToJson(ProductsModel data) => json.encode(data.toJson());
class ProductsModel {
  ProductsModel({
      bool? success, 
      String? message, 
